...
public class App {
		public static void main(String[] args) {
			...
			int num=0;
			System.out.println("choose a number: 1 add country, 2 display country , 3 delete country , 4 modify , 6 end");
      ...
      case 4 :
				...
				System.out.println("entrer the code to modify the country  : ");
